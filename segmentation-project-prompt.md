...
3. **Dataset:** [DESCRIBE THE DATASET YOUR TEAMMATE SENT — name, size, format of images and masks, number of classes, folder structure. Paste a sample of the directory listing if possible.]
